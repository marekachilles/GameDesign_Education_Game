...
export default class BallRightChoiceState extends WhatIsAGameState {
    enter(): void {
        this.givePlayerBall(false);
        this.scene.companion.say(
            'Sehr gut! Die Leertaste eignet sich tatsächlich am Besten. Häufig werden die Tasten F11 oder ESC mit anderen Funktionen belegt, was dann zu Schwierigkeiten führen kann.',
            () =>
                this.scene.companion.say(
